...
export default {
  ...
  data() {
    return {
      ...
      images: [
        {
          url: '/illustrations/photos/photo1.svg',
          alt: 'image1',
          class: 'mx-3',
        },
        {
          url: '/illustrations/photos/photo2.svg',
          alt: 'image2',
          class: 'mx-3 my-12',
        },
        {
          url: '/illustrations/photos/photo3.svg',
          alt: 'image3',
          class: 'mx-3 my-12',
        },
        {
          url: '/illustrations/photos/photo4.svg',
          alt: 'image4',
          class: 'mx-3',
        },
      ],
  ...
  methods: {
    getImageClass(index) {
      return this.images[index].class + ' h-48 rounded-full';
    },
  },
}
</script>
